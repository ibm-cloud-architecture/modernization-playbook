...
Now proceed to the [Liberty - Deploy](liberty-deploy) section where the process of automating the deployment of the application to a Kubernetes runtime will be covered step-by-step
