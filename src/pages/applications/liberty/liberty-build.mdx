...
Now proceed to the either the [Liberty - Deploy using Cloud Native Toolkit](liberty-deploy-cloudnativetoolkit) section or the [Liberty - Deploy using OpenShift Pipelines](liberty-deploy-tekton) section where the process of automating the deployment of the application to a Kubernetes runtime will be covered step-by-step
