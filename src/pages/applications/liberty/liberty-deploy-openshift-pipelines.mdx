---
title: Modernizing runtimes with Liberty - Deploy using OpenShift Pipelines on OCP 4.3+
...
export const Title = () => (
  <span>
Modernizing runtimes with Liberty <br/> <h2>Deploy using OpenShift Pipelines on OCP 4.3+</h2>
  </span>
);
