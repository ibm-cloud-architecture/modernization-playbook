...
- [Deploy the solution on Red Hat OpenShift using Cloud Nativet Toolkit Pipelines](liberty/liberty-deploy-cloud-native-toolkit)
- [Deploy the solution on Red Hat OpenShift using OpenShift Pipelines (Tekton)](liberty/liberty-deploy-openshift-pipelines)
...
The [steps](liberty/liberty-deploy-cloud-native-toolkit) will deploy the modernized Customer Order Services application in a WebSphere Liberty container to a Red Hat OpenShift cluster using the pipelines provided by the **Cloud Native Toolkit**.
...
Detailed, step-by-step instructions on how to replicate these steps are provided [here](liberty/liberty-deploy-cloud-native-toolkit)

### Deploy using OpenShift Pipelines
The [steps](liberty/liberty-deploy-openshift-pipelines) will deploy the modernized Customer Order Services application in a WebSphere Liberty container to a Red Hat OpenShift cluster using **OpenShift Pipelines**.
...
Detailed, step-by-step instructions on how to replicate these steps are provided [here](liberty/liberty-deploy-openshift-pipelines)
