...
- [Deploy the solution on OCP 4.3 using OpenShift Pipelines (Tekton)](liberty/liberty-deploy-tekton)
- [Deploy the solution on OCP 4.3 using Jenkins](liberty/liberty-deploy-43-jenkins)
...
Detailed, step-by-step instructions on how to replicate these steps are provided [here](liberty/liberty-analyze)
...
Detailed, step-by-step instructions on how to replicate these steps are provided [here](liberty/liberty-build)

### Deploy

<AnchorLinks>
  <AnchorLink>Deploy using Tekton </AnchorLink>
  <AnchorLink>Deploy using Jenkins on OCP 4.3</AnchorLink>
</AnchorLinks>

### Deploy using Tekton
The [steps](liberty-deploy-tekton) will deploy the modernized Customer Order Services application in a WebSphere Liberty container to a Red Hat OpenShift cluster using **OpenShift Pipelines**.
...
Detailed, step-by-step instructions on how to replicate these steps are provided [here](liberty-deploy-tekton)

### Deploy using Jenkins on OCP 4.3
The [steps](liberty-deploy-43-jenkins) describe the process to create the Jenkins, Kubernetes and RedHat OpenShift artifacts required to automate the build and deployment pipeline for the application. For illustration purposes, the application was deployed to three different RedHat OpenShift projects to simulate `development`, `staging` and `production`. The diagram below shows the flow through the pipeline.
...
Detailed, step-by-step instructions on how to replicate these steps are provided [here](liberty-deploy-43-jenkins)
