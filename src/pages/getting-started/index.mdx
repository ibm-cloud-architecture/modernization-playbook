...
* [Runtime modernization](./liberty/index) -- Updating the application runtime to a suitable cloud-native framework (Liberty) and deploying in Red Hat OpenShift. This solution shows different deployment options including using modern CI/CD tools (Tekton & ArgoCD) and using heritage CI/CD tools (Jenkins)

### Refactoring Java EE Applications
* [Refactoring the application](./refactor/index) from a monolith to a set of micro services
